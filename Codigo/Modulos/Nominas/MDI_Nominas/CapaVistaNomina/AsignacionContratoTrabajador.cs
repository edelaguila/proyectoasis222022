...
{
    public partial class AsignacionContratoTrabajador : Form
    {

        string table = "tbl_asignacion_contratotrabajador";
        int cont = 1;
        ...
        public AsignacionContratoTrabajador()
        {
            InitializeComponent();
        }
        ...
        private void AsignacionContratoTrabajador_Load(object sender, EventArgs e)
        {
            txtTrabajador.Visible = false;
        }
    }
